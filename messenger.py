...
def messenger(driver):
  ...
  WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.XPATH, '/html/body/div/div/dialog/div/div/div/div[3]/div[2]/div/button'))).click()
  driver.get(link)
  ...
  textBox.send_keys('***From wordle bot***' + Keys.SHIFT + Keys.ENTER)
